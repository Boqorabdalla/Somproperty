 ...
 * @property-read PermissionType $permissionType
 *
...
class PermissionRole extends BaseModel
{
    ...
    public static function employeeRolePermissions()
    {
        ...
        $employeePermissionsArray = [
            ...
            'view_material' => PermissionType::ALL,
            'add_material' => PermissionType::ADDED,
            'edit_material' => PermissionType::ADDED,
            'delete_material' => PermissionType::ADDED,

            'view_equipment' => PermissionType::ALL,
            'add_equipment' => PermissionType::ADDED,
            'edit_equipment' => PermissionType::ADDED,
            'delete_equipment' => PermissionType::ADDED,

            'view_subcontractor' => PermissionType::ALL,
            'add_subcontractor' => PermissionType::ADDED,
            'edit_subcontractor' => PermissionType::ADDED,
            'delete_subcontractor' => PermissionType::ADDED,

            'view_purchase_order' => PermissionType::ALL,
            'add_purchase_order' => PermissionType::ADDED,
            'edit_purchase_order' => PermissionType::ADDED,
            'delete_purchase_order' => PermissionType::ADDED,

            'view_progress_report' => PermissionType::ALL,
            'add_progress_report' => PermissionType::ADDED,
            'edit_progress_report' => PermissionType::ADDED,
            'delete_progress_report' => PermissionType::ADDED,

            'view_incident' => PermissionType::ALL,
            'add_incident' => PermissionType::ADDED,
            'edit_incident' => PermissionType::ADDED,
            'delete_incident' => PermissionType::ADDED,

            'view_change_order' => PermissionType::ALL,
            'add_change_order' => PermissionType::ADDED,
            'edit_change_order' => PermissionType::ADDED,
            'delete_change_order' => PermissionType::ADDED,
