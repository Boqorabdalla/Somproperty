...
return array(
    ...
    'accountSettings' => array(
        ...
        'partnerAppDownloadsHelp' => 'Set public download links for your mobile apps. These URLs are shared with all companies using this installation.',
        'iosAppUrl' => 'iOS App Store / TestFlight URL',
        'androidAppUrl' => 'Google Play / Android distribution URL',
        'clearUrl' => 'Clear',
        'resetUrlToDefault' => 'Reset to default',
        'openDownloadLink' => 'Open link',
        'downloadsMobileHeading' => 'Mobile',
        'downloadsStoreLinksSection' => 'Mobile store links',
        'downloadsCardIosTitle' => 'Apple iOS',
        'downloadsCardAndroidTitle' => 'Google Android',
        'downloadsEmptyTitle' => 'No links yet',
        'downloadsSaveHint' => 'Changes apply immediately for all users who can open this page.',
        'downloadsAppleDevLink' => 'Apple Developer Program',
        'downloadsGooglePlayConsoleLink' => 'Google Play Console',
        'downloadsReadOnlyHelp' => 'These links are managed globally. You can open them below or copy from the fields.',
        'downloadsUrlNotConfigured' => 'Not configured',
        'downloadsAndroidBlurb' => 'Get the Android app for phones and tablets.',
        'downloadsIosBlurb' => 'Get the iOS app from the App Store or TestFlight.',
        'downloadsMobileEmpty' => 'No mobile download links have been configured yet. Ask your administrator to add them under Settings → Downloads.',
        'downloadsPlayStoreHint' => 'This link points to Google Play.',
        'downloadsAppStoreHint' => 'This link points to the Apple App Store or TestFlight.',
        'downloadCta' => 'Download',
        'downloadsWhiteLabelTitle' => 'Custom Logo apps',
        'downloadsWhiteLabelBody' => 'Publishing under your own developer accounts typically requires Apple and Google developer memberships. Use the official console links below for more information.',
    ),
    'profile' => array(
    ...
    'invoiceSettings' => array(
        ...
        'showEstimateItemSelectionColumn' => 'Show item selection column on estimates',
        'showEstimateItemSelectionColumnInfo' => 'When disabled, the item selection column is hidden on estimate views (where your estimate status allows that column).',
        'estimateItemSelectionColumn' => 'Item Selection',
        'syncType' => 'Sync Type',
    ...
    'attendance' => array(
        ...
        'present' => 'Present',
        'workFromHomeLegend' => 'Work from home',
