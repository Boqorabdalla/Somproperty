@php
    ...
    $duplicateDataChecked = request()->has('duplicate_task');
                    ...
                    @if (!is_null($task))
                        <div class="col-md-12 pt-4">
                            <div class="border rounded p-3 bg-light">
                                <h5 class="f-15 text-dark-grey mb-3">@lang('app.duplicate') @lang('app.details')</h5>
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_files"
                                            fieldId="duplicate_files"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate Files"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_sub_tasks"
                                            fieldId="duplicate_sub_tasks"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate Sub Task"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_comments"
                                            fieldId="duplicate_comments"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate Comments"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_timesheet"
                                            fieldId="duplicate_timesheet"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate Timesheet"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_notes"
                                            fieldId="duplicate_notes"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate Notes"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <x-forms.checkbox
                                            fieldName="duplicate_history"
                                            fieldId="duplicate_history"
                                            fieldValue="yes"
                                            fieldLabel="Duplicate History"
                                            :checked="$duplicateDataChecked"/>
                                    </div>
                                </div>
                            </div>
