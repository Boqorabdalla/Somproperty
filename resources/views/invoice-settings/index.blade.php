                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            @if (in_array('estimates', user_modules()))
                                <a class="nav-item nav-link f-15 estimate-setting"
                                    href="{{ route('invoice-settings.index') }}?tab=estimate-setting" role="tab"
                                    aria-controls="nav-ticketTypes" aria-selected="true">@lang('app.menu.estimateSettings')
                                </a>
                            @endif
