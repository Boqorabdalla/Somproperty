...
<!-- NAV ITEM - CONSTRUCTION COLLAPSE MENU -->
    @if (!in_array('client', user_roles()) && (in_array('materials', user_modules()) || in_array('equipment', user_modules()) || in_array('subcontractors', user_modules()) || in_array('vendors', user_modules()) || in_array('purchases', user_modules()) || in_array('progress-reports', user_modules()) || in_array('incidents', user_modules()) || in_array('change-orders', user_modules())) && ($sidebarUserPermissions['view_material'] != 5 || $sidebarUserPermissions['view_equipment'] != 5 || $sidebarUserPermissions['view_subcontractor'] != 5 || $sidebarUserPermissions['view_vendor'] != 5 || $sidebarUserPermissions['view_purchase_order'] != 5 || $sidebarUserPermissions['view_progress_report'] != 5 || $sidebarUserPermissions['view_incident'] != 5 || $sidebarUserPermissions['view_change_order'] != 5) && ($sidebarUserPermissions['view_material'] != 'none' || $sidebarUserPermissions['view_equipment'] != 'none' || $sidebarUserPermissions['view_subcontractor'] != 'none' || $sidebarUserPermissions['view_vendor'] != 'none' || $sidebarUserPermissions['view_purchase_order'] != 'none' || $sidebarUserPermissions['view_progress_report'] != 'none' || $sidebarUserPermissions['view_incident'] != 'none' || $sidebarUserPermissions['view_change_order'] != 'none'))
        <x-menu-item icon="cone-striped" :text="__('app.menu.construction')">
            <x-slot name="iconPath">
                <path d="M9.957 2.396a.75.75 0 0 1 1.059 0l3.338 3.338a.75.75 0 0 1 0 1.059l-3.338 3.338a.75.75 0 0 1-1.059 0L6.62 6.793a.75.75 0 0 1 0-1.059l3.337-3.338z"/>
                <path d="M11.5 1.5a.75.75 0 0 0 0 1.53v.77l2.38 2.38a.75.75 0 0 0 1.06 0l.77-.77a.75.75 0 0 0 0-1.06l-3.5-3.5a.75.75 0 0 0-1.06 0l-.77.77a.75.75 0 0 0 0 1.06l.12.12V1.5zM6.97 6.03a.75.75 0 0 1 1.06 0l3.338 3.338a.75.75 0 0 1 0 1.059l-3.338 3.338a.75.75 0 0 1-1.059 0L3.632 10.43a.75.75 0 0 1 0-1.06L6.97 6.03z"/>
                <path d="M6.97 12.47a.75.75 0 0 1 1.06 0l.77.77a.75.75 0 0 1 0 1.06l-3.5 3.5a.75.75 0 0 1-1.06 0l-.77-.77a.75.75 0 0 1 0-1.06l.12-.12H2.75a.75.75 0 0 1 0-1.53v-.77L.37 11.37a.75.75 0 0 1-1.06 0l-.77-.77a.75.75 0 0 1 0-1.06l3.5-3.5a.75.75 0 0 1 1.06 0l.77.77a.75.75 0 0 1 0 1.06l-.12.12h1.01l.01.01 1.2 1.2z"/>
            </x-slot>
            <div class="accordionItemContent">
                @if (in_array('materials', user_modules()) && $sidebarUserPermissions['view_material'] != 5 && $sidebarUserPermissions['view_material'] != 'none')
                    <x-sub-menu-item :link="route('materials.index')" :text="__('app.menu.materials')" />
                @endif
                @if (in_array('equipment', user_modules()) && $sidebarUserPermissions['view_equipment'] != 5 && $sidebarUserPermissions['view_equipment'] != 'none')
                    <x-sub-menu-item :link="route('equipment.index')" :text="__('app.menu.equipment')" />
                @endif
                @if (in_array('subcontractors', user_modules()) && $sidebarUserPermissions['view_subcontractor'] != 5 && $sidebarUserPermissions['view_subcontractor'] != 'none')
                    <x-sub-menu-item :link="route('subcontractors.index')" :text="__('app.menu.subcontractors')" />
                @endif
                @if (in_array('vendors', user_modules()) && $sidebarUserPermissions['view_vendor'] != 5 && $sidebarUserPermissions['view_vendor'] != 'none')
                    <x-sub-menu-item :link="route('vendors.index')" :text="__('app.menu.vendors')" />
                @endif
                @if (in_array('purchases', user_modules()) && $sidebarUserPermissions['view_purchase_order'] != 5 && $sidebarUserPermissions['view_purchase_order'] != 'none')
                    <x-sub-menu-item :link="route('purchase-orders.index')" :text="__('app.menu.purchaseOrders')" />
                @endif
                @if (in_array('progress-reports', user_modules()) && $sidebarUserPermissions['view_progress_report'] != 5 && $sidebarUserPermissions['view_progress_report'] != 'none')
                    <x-sub-menu-item :link="route('progress-reports.index')" :text="__('app.menu.progressReports')" />
                @endif
                @if (in_array('incidents', user_modules()) && $sidebarUserPermissions['view_incident'] != 5 && $sidebarUserPermissions['view_incident'] != 'none')
                    <x-sub-menu-item :link="route('incidents.index')" :text="__('app.menu.incidents')" />
                @endif
                @if (in_array('change-orders', user_modules()) && $sidebarUserPermissions['view_change_order'] != 5 && $sidebarUserPermissions['view_change_order'] != 'none')
                    <x-sub-menu-item :link="route('change-orders.index')" :text="__('app.menu.changeOrders')" />
                @endif
            </div>
        </x-menu-item>
    @endif
