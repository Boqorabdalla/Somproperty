<div class="row">
    <div class="col-sm-12">
        <x-form id="save-progress-report-form" method="PUT">
                ...
                <div class="p-20 row">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="project_id" id="project_id"
                                ...
                                @foreach ($projects as $project)
                                    <option @selected($report->project_id == $project->id)
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="milestone_id" id="milestone_id"
                                ...
                                @foreach ($milestones as $milestone)
                                    <option @selected($report->milestone_id == $milestone->id)
                    ...
                    <div class="col-md-4">
                        <x-forms.datepicker fieldId="report_date" fieldRequired="true"
                                            ...
                                            :fieldValue="$report->report_date->format(company()->date_format)"/>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description-text" class="d-none">{!! $report->description !!}</textarea>
                    </div>

                    <div class="col-md-12">
                        <x-forms.label class="my-3" fieldId="work_summary" :fieldLabel="'Work Summary'">
                        </x-forms.label>
                        <div id="work_summary">{!! $report->work_summary !!}</div>
                        <textarea name="work_summary" id="work_summary-text" class="d-none">{!! $report->work_summary !!}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2"
                                      ...
                                      :fieldValue="$report->weather_conditions"/>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-progress-report-form-btn').click(function() {
            ...
            const url = "{{ route('progress-reports.update', $report->id) }}";
