<div class="row">
    <div class="col-sm-12">
        <x-form id="save-equipment-data-form">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.select fieldId="equipment_type_id" :fieldLabel="'Equipment Type'" fieldName="equipment_type_id"
                            ...
                            @foreach ($equipmentTypes as $equipmentType)
                                <option value="{{ $equipmentType->id }}">{{ $equipmentType->type_name }}</option>
                            @endforeach
                        </x-forms.select>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text fieldId="model" :fieldLabel="'Model'" fieldName="model"
                            :fieldPlaceholder="__('placeholders.model')">
                        </x-forms.text>
                    </div>

                    <div class="col-lg-4 col-md-6">
                        <x-forms.text fieldId="serial_no" :fieldLabel="'Serial No'" fieldName="serial_no"
                            :fieldPlaceholder="__('placeholders.serialNo')">
                        </x-forms.text>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-equipment-form').click(function() {
            const url = "{{ route('equipment.store') }}";
