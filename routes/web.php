...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('materials/adjust-stock/{id}', [MaterialController::class, 'adjustStock'])->name('materials.adjust_stock');

    Route::resource('equipment', EquipmentController::class);
    Route::post('equipment/log-maintenance/{id}', [EquipmentController::class, 'logMaintenance'])->name('equipment.log_maintenance');
    ...
    Route::post('purchase-orders/change-status/{id}', [PurchaseOrderController::class, 'changeStatus'])->name('purchase-orders.change_status');

    Route::resource('progress-reports', ProgressReportController::class);
    Route::post('progress-reports/approve/{id}', [ProgressReportController::class, 'approve'])->name('progress-reports.approve');

    Route::resource('incidents', IncidentController::class);
    Route::post('incidents/close/{id}', [IncidentController::class, 'close'])->name('incidents.close');

    Route::resource('change-orders', ChangeOrderController::class);
    Route::post('change-orders/approve/{id}', [ChangeOrderController::class, 'approve'])->name('change-orders.approve');
...
Route::get('/test-broadcast', function () {
    try {
        event(new MessageSent(ChatMessage::first()));
