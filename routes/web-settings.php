...
use App\Http\Controllers\AppDownloadsController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('invoice-settings/update-estimate-setting/{id}', [InvoiceSettingController::class, 'updateEstimateSetting'])->name('invoice_settings.update_estimate_setting');
    ...
    // Tax Settings
    Route::put('taxes/{tax}/to-keep-under-total-payment', [TaxSettingController::class, 'updateToKeepUnderTotalPayment'])->name('taxes.update_to_keep_under_total_payment');
    ...
    Route::get('downloads', [AppDownloadsController::class, 'index'])->name('downloads.index');
    Route::match(['post', 'put'], 'downloads', [AppDownloadsController::class, 'update'])->name('downloads.update');
